  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-slate-200 bg-white p-4">
      ...
      <dl className="grid grid-cols-2 gap-x-3 gap-y-1 text-xs text-slate-600">
        <dt>Individuals</dt>
        <dd className="font-medium text-slate-900">{personCount}</dd>
        <dt>Families</dt>
        <dd className="font-medium text-slate-900">{familyCount}</dd>
        <dt>Edits made this session</dt>
        <dd className="font-medium text-slate-900">{editCount}</dd>
        <dt>Validation warnings</dt>
        <dd className="font-medium text-slate-900">{warnings.length}</dd>
      </dl>

...
export function UploadArea({ onFileSelected, onClear, accept, hint, currentFile, disabled }: UploadAreaProps) {
      ...
      {!currentFile ? (
        ...
        >
          ...
          <p className="text-base font-semibold text-slate-800">
            Drag &amp; drop your file here, or <span className="text-emerald-700 underline">browse</span>
          </p>

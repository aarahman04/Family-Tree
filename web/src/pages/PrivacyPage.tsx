export function PrivacyPage() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <section>
        <h2 className="text-lg font-semibold text-slate-900">No uploads to a server</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-slate-900">No tracking, no analytics</h2>
        <p className="mt-2 text-slate-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-slate-900">No personal data stored</h2>
        <p className="mt-2 text-slate-600">
      ...
      <section>
        <h2 className="text-lg font-semibold text-slate-900">If this ever changes</h2>
        <p className="mt-2 text-slate-600">

...
## Corpus Check
- 224 files · ~166,769 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1370 nodes · 2682 edges · 128 communities (109 shown, 19 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6106c434`
...
- gedcom/index.ts
- addRelative.ts
- poster-balanced.test.ts
- useTreeEditor.ts
- unsavedEdits.test.tsx
- typescript
- fields.ts
- explorer.test.tsx
...
- `SearchIndexEntry` --references--> `UUID`  [EXTRACTED]
  web/src/lib/search.ts → src/models/types.ts
- `SearchResult` --references--> `UUID`  [EXTRACTED]
  web/src/lib/search.ts → src/models/types.ts
- `DownloadPanelProps` --references--> `ValidationIssue`  [EXTRACTED]
  web/src/components/DownloadPanel.tsx → src/models/types.ts
- `CreateFamilyTreeWizardProps` --references--> `FamilyTree`  [EXTRACTED]
  web/src/components/CreateFamilyTreeWizard.tsx → src/models/types.ts
- `SavedSession` --references--> `FamilyTree`  [EXTRACTED]
  web/src/lib/autosave.ts → src/models/types.ts
...
### Community 0 - "personRow"
Cohesion: 0.18
Nodes (17): parseNodeFtt(), nuclearFamilyTree(), treeFrom(), buildNodeFtt(), familyRow(), FamilyRowOptions, personRow(), PersonRowOptions (+9 more)

### Community 2 - "insights.ts"
Cohesion: 0.14
Nodes (12): InsightsStrip(), computeGenerations(), gen(), computeTreeInsights(), countDisconnectedGroups(), displayName(), NamedCount, parentIdsOf() (+4 more)

### Community 3 - "useTreeImport.ts"
Cohesion: 0.06
Nodes (44): ValidationState, App(), guardNavigation(), Header(), HeaderProps, LINKS, MobileMenu(), LayoutProps (+36 more)

### Community 4 - "EditorPage.tsx"
Cohesion: 0.06
Nodes (28): deletePerson(), DisplayMode, PhotoShape, AppearanceMenu(), AppearanceMenuProps, MODES, SHAPES, ExportMenuProps (+20 more)
...
### Community 7 - "UUID"
Cohesion: 0.27
Nodes (7): UUID, DescentConnector, MarriageConnector, PosterNode, SpineConnector, EditorCanvasProps, hitTestNode()
...
Cohesion: 0.15
Nodes (9): posterLayoutKey(), DEFAULT_POSTER_STYLE, PDF_MAX_DIMENSION_PT, PosterLayout, PosterPageSize, PosterTheme, minimal, photoCards (+1 more)
...
Cohesion: 0.11
Nodes (18): scripts, compilerOptions, declaration, esModuleInterop, lib, module, moduleResolution, noUncheckedIndexedAccess (+10 more)

### Community 12 - "compilerOptions"
Cohesion: 0.10
Nodes (20): compilerOptions, esModuleInterop, isolatedModules, jsx, lib, module, moduleDetection, moduleResolution (+12 more)

### Community 13 - "models/types.ts"
Cohesion: 0.10
Nodes (21): DATE_QUALIFIERS, GedLine, importGedcom(), MONTHS, parseGedcomName(), parseGender(), tokenize(), Event (+13 more)
...
Cohesion: 0.23
Nodes (12): exportGedcom(), genderToSex(), writeFam(), writeHeader(), writeIndi(), formatGedcomName(), splitName(), validateForExport() (+4 more)

### Community 18 - "compilerOptions"
Cohesion: 0.12
Nodes (16): node, vite.config.ts, compilerOptions, lib, module, moduleDetection, moduleResolution, noEmit (+8 more)

### Community 19 - "PersonPicker.tsx"
Cohesion: 0.18
Nodes (12): DownloadPanel(), DownloadPanelProps, gedcomFileName(), ErrorPanel(), ErrorPanelProps, PersonInspectorProps, PersonPicker(), PersonPickerProps (+4 more)
...
### Community 23 - "EditorCanvas.tsx"
Cohesion: 0.11
Nodes (21): clampScale(), EditorCanvas, EditorCanvasHandle, MINIMAP_MAX, Transform, downloadBlob(), formatMeters(), PosterExportPanel() (+13 more)
...
### Community 35 - "operations.ts"
Cohesion: 0.20
Nodes (24): pruneEmptyFamily(), withFamily(), withPerson(), addChildToFamily(), addChildToPerson(), addSpouse(), assignParent(), ensureFamcFamily() (+16 more)
...
Cohesion: 0.13
Nodes (15): Contributing, Deployment, Development, FAQ, How it's built, License, Privacy, in one sentence, Project status: Version 1.0 (+7 more)
...
### Community 101 - "unsavedEdits.ts"
Cohesion: 0.15
Nodes (11): setHasUnsavedEdits(), fixtureFile(), openEditor(), fixtureFile(), openEditorAndSelectRoot(), fixtureFile(), openEditorAtWidth(), __dirname (+3 more)

### Community 109 - "parser/index.ts"
Cohesion: 0.18
Nodes (16): MediaRef, NoteEntry, ValidationIssue, BuildResult, buildTree(), genderFromCode(), padRow(), ParsedFamilyRow (+8 more)

### Community 110 - "renderSvg.ts"
Cohesion: 0.32
Nodes (16): CARD_DIVIDER_GAP, PHOTO_TOP_PAD, photoAreaHeight(), escapeXml(), genderIcon(), num(), photoClip(), photoPlaceholder() (+8 more)

### Community 111 - "Gender"
Cohesion: 0.20
Nodes (13): PersonFieldEdits, RawFam, RawIndi, DatePart, Gender, PersonOpts, CreateFamilyTreeWizard(), handleCreate() (+5 more)

### Community 112 - "verify.ts"
Cohesion: 0.18
Nodes (14): main(), ROOT, SAMPLE_PATH, ancestorFtzSet(), ancestorFtzSetFromGedcom(), ParsedFamily, ParsedPerson, parseGedcomForVerification() (+6 more)

### Community 113 - "FamilyTree"
Cohesion: 0.11
Nodes (11): FamilyTree, PersonPhoto, photo, AddPersonMenuProps, QuickActionsProps, PosterExportPanelProps, TreeSession, TreeSessionContext (+3 more)

### Community 114 - "relationships.ts"
Cohesion: 0.19
Nodes (15): EditorError, isAncestor(), childrenOf(), fatherOf(), getRelationships(), grandchildrenOf(), grandparentsOf(), motherOf() (+7 more)

### Community 115 - "setup.ts"
Cohesion: 0.18
Nodes (4): DOMMatrixReadOnlyPolyfill, FAKE_SIZE, resetGlobalEditorState(), ResizeObserverPolyfill

### Community 116 - "tokenizer.ts"
Cohesion: 0.20
Nodes (9): FtzParseError, FAMILY_FIELD_COUNT, PERSON_FIELD_COUNT, tokenizeNodeFtt(), declaredUncompressedSize(), extractNodeFtt(), formatMB(), MAX_ARCHIVE_BYTES (+1 more)

### Community 117 - "largeTree.test.ts"
Cohesion: 0.24
Nodes (10): buildSearchIndex(), SearchIndexEntry, searchPeople(), SearchResult, Host(), idOf(), tree(), treeWithKidPhoto() (+2 more)
...
### Community 120 - "gedcom/index.ts"
Cohesion: 0.20
Nodes (8): GedcomExportError, GedcomImportError, ExportOptions, parseGedcomDate(), XrefAllocator, __dirname, FTZ_SAMPLE, GED_SAMPLE

### Community 121 - "addRelative.ts"
Cohesion: 0.35
Nodes (8): createPerson(), AddPersonMenu(), addIndependent(), addLinked(), QuickActions(), add(), addRelative(), RelativeKind

### Community 122 - "poster-balanced.test.ts"
Cohesion: 0.31
Nodes (7): buildTree(), __dirname, family(), person(), SAMPLE_EXISTS, SAMPLE_PATH, threeBranchTree()

### Community 123 - "useTreeEditor.ts"
Cohesion: 0.43
Nodes (6): applyEdit(), Action, EditorState, initState(), reducer(), useTreeEditor()

### Community 124 - "unsavedEdits.test.tsx"
Cohesion: 0.53
Nodes (5): buildFixtureFile(), makeOneEdit(), selectTheOnlyPerson(), uploadIntoEditor(), uploadOnHome()

### Community 126 - "fields.ts"
Cohesion: 0.50
Nodes (4): findUnmappedPopulatedFields(), isPopulated(), UNMAPPED_FAMILY_INDICES, UNMAPPED_PERSON_INDICES

## Knowledge Gaps
- **531 isolated node(s):** `name`, `version`, `private`, `type`, `description` (+526 more)
...
- **Why does `FamilyTree` connect `FamilyTree` to `personRow`, `insights.ts`, `useTreeImport.ts`, `EditorPage.tsx`, `UUID`, `computePosterLayout`, `poster/types.ts`, `models/types.ts`, `export.ts`, `PersonPicker.tsx`, `layoutBalanced.ts`, `EditorCanvas.tsx`, `mockWorker.ts`, `poster-photo-render.test.ts`, `poster-balanced-fragments.test.ts`, `operations.ts`, `layout.ts`, `parser/index.ts`, `Gender`, `verify.ts`, `relationships.ts`, `largeTree.test.ts`, `gedcom/index.ts`, `addRelative.ts`, `poster-balanced.test.ts`, `useTreeEditor.ts`, `fields.ts`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `computePosterLayout()` connect `computePosterLayout` to `poster/types.ts`, `layout.ts`, `layoutBalanced.ts`, `EditorCanvas.tsx`, `poster-balanced.test.ts`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `UUID` connect `UUID` to `insights.ts`, `EditorPage.tsx`, `computePosterLayout`, `poster/types.ts`, `models/types.ts`, `PersonPicker.tsx`, `layoutBalanced.ts`, `EditorCanvas.tsx`, `poster-photo-render.test.ts`, `poster-balanced-fragments.test.ts`, `operations.ts`, `layout.ts`, `parser/index.ts`, `renderSvg.ts`, `Gender`, `verify.ts`, `FamilyTree`, `relationships.ts`, `largeTree.test.ts`, `gedcom/index.ts`, `addRelative.ts`, `poster-balanced.test.ts`?**
...
- **Should `useTreeImport.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.06001984126984127 - nodes in this community are weakly interconnected._
- **Should `EditorPage.tsx` be split into smaller, more focused modules?**
